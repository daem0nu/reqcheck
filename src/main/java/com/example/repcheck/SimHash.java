...
public class SimHash
{
    ...
    public BigInteger simHash() throws IOException
    {
        ...
        String word = null;
        String c = clean(this.tokens);
        List<Term> terms = StandardTokenizer.segment(c);//分词

        Map<String, Integer> weightOfNature = new HashMap<String, Integer>(); // 词性的权重
        weightOfNature.put("v", 7); weightOfNature.put("vn", 7); weightOfNature.put("vd", 7);//给动词的权重是7;
        weightOfNature.put("vg", 7);//给动词的权重是7;
        weightOfNature.put("n", 6); weightOfNature.put("ns", 6); weightOfNature.put("nz", 6);//给名词的权重是6;
        weightOfNature.put("ns", 6); weightOfNature.put("j", 6); weightOfNature.put("nr", 6);//给名词的权重是6;
        weightOfNature.put("r", 5); //给代词的权重是5;
        weightOfNature.put("l", 4); weightOfNature.put("i", 4); weightOfNature.put("a", 4);//给修饰的权重是4;
        weightOfNature.put("an", 4); weightOfNature.put("ad", 4); weightOfNature.put("ag", 4);//给修饰的权重是4;
        weightOfNature.put("z", 4); weightOfNature.put("b", 4);//给修饰的权重是4;
        weightOfNature.put("d", 1); weightOfNature.put("t", 1);//给副词的权重是1;
        weightOfNature.put("m", 2); weightOfNature.put("q", 2);//给量词的权重是2;
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        double rat3 = hash1.getSemblance(hash3);
        System.out.println(hash1.strSimHash);
